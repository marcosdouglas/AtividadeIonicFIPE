...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      Tabela FIPE App\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n    <div style=\"  margin: auto;\n  width: 90%;\n  padding: 9%;margin-top: 18%;\">\n        <ion-button expand=\"full\" color=\"primary\" (click)=\"listaMarcas('carros');\"> Carros</ion-button>\n        <ion-button expand=\"full\" color=\"primary\" (click)=\"listaMarcas('motos');\">Motos</ion-button>\n        <ion-button expand=\"full\" color=\"primary\" (click)=\"listaMarcas('caminhoes');\">Caminhões</ion-button>\n    </div>\n</ion-content>\n\n"
...
/***/ "./src/app/services/fipe.service.ts":
/*!******************************************!*\
  !*** ./src/app/services/fipe.service.ts ***!
  \******************************************/
/*! exports provided: FipeService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FipeService", function() { return FipeService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var FipeService = /** @class */ (function () {
    function FipeService(httpClient) {
        this.httpClient = httpClient;
    }
    FipeService.prototype.getMarcas = function (veiculo) {
        return this.httpClient.get("https://fipeapi.appspot.com/api/1/" + veiculo + "/marcas.json");
    };
    FipeService.prototype.getModelos = function (id) {
        return this.httpClient.get("https://fipeapi.appspot.com/api/1/" + _home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"].veiculo + "/veiculos/" + id + ".json");
    };
    FipeService.prototype.getAnos = function (id) {
        return this.httpClient.get("https://fipeapi.appspot.com/api/1/" + _home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"].veiculo + "/veiculo/" + _home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"].id_marca + "/" + id + ".json");
    };
    FipeService.prototype.getConsulta = function (id) {
        return this.httpClient.get("https://fipeapi.appspot.com/api/1/" + _home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"].veiculo + "/veiculo/" + _home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"].id_marca + "/" + _home_home_page__WEBPACK_IMPORTED_MODULE_3__["HomePage"].id_ano + "/" + id + ".json");
    };
    FipeService.items = [];
    FipeService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
